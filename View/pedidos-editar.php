...
<form action="?c=pedidos&a=Guardar" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" name="NoArticulos" value="<?php echo $alm->NoArticulos; ?>" class="form-control" placeholder="Ingrese el numero de articulos" data-validacion-tipo="requerido|NoArticulos" />
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" name="DireccionEnvio" value="<?php echo $alm->DireccionEnvio; ?>" class="form-control" placeholder="Ingrese su direccion de envio" data-validacion-tipo="requerido|DireccionEnvio" />
    </div>
